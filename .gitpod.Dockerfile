...
# For linux-desktop support for flutter
USER gitpod
RUN sudo apt-get update -y \
    && sudo apt-get install -y clang cmake ninja-build pkg-config libgtk-3-dev liblzma-dev libgtk-3-0 libblkid1 liblzma5